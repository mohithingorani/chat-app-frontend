    ...
    return (
        <footer className="w-full bg-[#111111] bg-opacity-75 text-white py-2  ">
            ...
            <div className="flex justify-center gap-12 items-center">
                <Link href="https://www.instagram.com/mohit_hingorani/">
                    <svg className="hover:scale-105" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
                ...
                <Link href="https://www.linkedin.com/in/mohit-hingorani-439265248/">
                    <svg className="hover:scale-105" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 20 20">
                ...
                <Link href="https://github.com/mohithingorani">
                    <svg className="hover:scale-105" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 432 416">
